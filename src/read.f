...
!      write(6,"(a, i3)") " OpenMP num threads: ", OMP_GET_NUM_THREADS()
      ...
      read(5,*)epsilon
      read(5,*)batches
      read(5,*)(sx(i),i=1,batches)
      read(5,*)(sc(i),i=1,batches)
...
c          if (vvx.lt.0.1) print *,ndat,vvx
      ...
      write(6,'(a20,100F25.14)')
     &    'Found batch mins: ',(vvmin(i),i=1,batches)
      write(6,'(a20,100F25.14)')
     &    'User defined mins:',(sx(i),i=1,batches)

!      print *,(vvmin(i),i=1,batches)
!      print *,(sx(i),i=1,batches)
      do i=1,batches
        if (vvmin(i).lt.sx(i)) then
          sx(i)=vvmin(i)
          write(6,'(a15,i3,a5,F20.14)'),'Adjusting E0(',i,') to',sx(i)
        endif
      enddo
...
!      call svdfit(vv,sig,ndat,coef,ncoef,u,v,w,ndat,ncoef,chisq)
